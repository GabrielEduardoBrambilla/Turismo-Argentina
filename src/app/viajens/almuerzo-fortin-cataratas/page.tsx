...
const text = {
  firstSmallTitle: "",
  mainTitle: "ALMUERZO EN FORTIN CATARATAS",
  priceHigher: "$38,862",
  priceLower: "$30,600",
  discountPercent: "27% OFF",
  description:
    "Parrilla buffet tenedor libre con 1 postre por persona. Bebidas no incluidas. Menores hasta 6 años no abonan. De 7 a 12 abonan el 50%.",
  bannerBar: [
    {
      title: "Precio",
      message: "$30,600",
  ...
  infoSection: [
    {
      ...
      infoMessage:
        "Menores hasta 6 años no abonan. De 7 a 12 años abonan el 50%.",
    },
  ],
  bulletSection: [
    {
      bulletTitle: "No Incluye",
      bulletMessages: [{ content: "Bebidas" }],
    },
  ],
};
