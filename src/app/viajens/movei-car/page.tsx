...
const text = {
  firstSmallTitle: "",
  mainTitle: "MOVIE CARS INGRESOS",
  priceHigher: "R$101.60",
  priceLower: "R$80.00",
  discountPercent: "27% OFF",
  description:
    "LOS VEHÍCULOS QUE MARCARON LA HISTORIA DEL CINE, EN INCREÍBLE ESCENARIO. Ubicado en el principal corredor turístico de Foz do Iguaçu, Movie Cars presenta más de 50 vehículos en 24 escenarios que lo llevan a una verdadera inmersión cinematográfica. En el circuito de Movie Cars, los visitantes siempre se sorprenden. No incluye traslados.\n\nPrecio REALES (precio en pesos a cotización del día)\n\nR$80",
  bannerBar: [
    { title: "Ubicación", message: "Corredor turístico de Foz do Iguaçu" },
  ],
  infoSection: [
  ...
  bulletSection: [
    {
      ...
      bulletMessages: [
        { content: "Más de 50 vehículos históricos del cine." },
        { content: "24 escenarios temáticos para inmersión cinematográfica." },
        { content: "Circuito de Movie Cars para toda la familia." },
      ],
    },
  ],
};
